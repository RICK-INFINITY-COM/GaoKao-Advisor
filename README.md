# 2026高考志愿填报AI助手 - 开源精简版

> 极简的本地 AI 对话工具，自带轻量升学知识库（院校 / 专业 / 省控线）支撑。填入你自己的 DeepSeek API Key 即可使用，无需数据库、无次数限制、不经第三方中转。

<p align="center">
  <img width="426" alt="瑞克无限 横版动态LOGO" src="https://github.com/user-attachments/assets/4ce82a0b-6b1d-4ebd-abb9-9100d73e6dcd">
</p>
...
商业版已上线：[**rickinf.top**](https://rickinf.top) — 425万录取数据 + DeepSeek 驱动，免费试用 8 次。
...
<p align="center">
  <img width="360" alt="对话界面" src="https://github.com/user-attachments/assets/8f3f8842-6c6f-4a70-9593-f85f81ca3126">
  <img width="360" alt="API Key 设置" src="https://github.com/user-attachments/assets/b69fcd39-c2a3-4907-aee4-86faf27e0cb2">
</p>

> API Key 保存在浏览器本地缓存中，不经过服务器。默认代码仅支持 DeepSeek V4 的 Key，请自行前往 [platform.deepseek.com](https://platform.deepseek.com) 购买。
...
- **知识库支撑**：内置院校（2991 所）、专业目录（833 个）、近年省控线，提问时自动检索注入
...
打开页面后，点右上角 ⚙ 设置图标，填入 DeepSeek API Key，即可开始对话。
...
| 文件 | 内容 | 条数 |
|------|------|------|
| `schools.json` | 全国院校（含 985/211 标签、公办/民办、类型、所在地） | 2,991 |
